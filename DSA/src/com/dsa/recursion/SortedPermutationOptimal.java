...
class SortedPermutationOptimal 
{
...
//				System.out.println("P1.> CI - " + ceilIndex + " | str[i] " + str[i] + " | i+1 " + (i + 1));
//				System.out.println("P2.> " + Arrays.toString(str));

				// Swap first and second characters
				swap(str, i, ceilIndex);
//				System.out.println("P3.> " + Arrays.toString(str));

				// reverse the string on right of 'first
				// char'
				reverse(str, i + 1, size - 1);
//				System.out.println("P4.> " + Arrays.toString(str));

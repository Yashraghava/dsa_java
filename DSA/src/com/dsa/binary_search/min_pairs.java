...
public class min_pairs {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> a2 = new ArrayList<Integer>(Arrays.asList(26,134,135,15,17));
    ...
    public static void min_pair(ArrayList<Integer> a1,ArrayList<Integer> a2) {
        ...
        for(int x : a1){
            int bsearch = Collections.binarySearch(a2,x);
            System.out.println("a2 "+a2+"| x "+x+"| bsearch "+bsearch);
			int lb = bsearch - a2.get(0);

...
//CORRECTLY WORKING_IMPORTANT
class QuickSelect3 {
	// partition function similar to quick sort Considers last element as pivot and adds
	// elements with less value to the left and high value to the right and also changes
...
//            = new int[] { 10, 4, 5, 8, 6, 11, 26 };
		...
		int[] array = new int[] { 10, 0, 5, 2, 7, 6, 4 };
		int[] arraycopy = new int[] { 10, 0, 5, 2, 7, 6, 4 };
